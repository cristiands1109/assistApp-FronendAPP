  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-order-detail-order-detail-module"], {
    ...
    function srcAppPagesOrderDetailOrderDetailPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var OrderDetailPage = /*#__PURE__*/function () {
        function OrderDetailPage(route, navCtrl, denunciaService) {
          var _this = this;
          ...
          this.route.queryParams.subscribe(function (data) {
            // console.log(data);
            _this.emergenciaID = data.value;

            _this.getEmergenciabyID(_this.emergenciaID);
        ...
        _createClass(OrderDetailPage, [{
          ...
          key: "getEmergenciabyID",
          value: function getEmergenciabyID(emergenciaID) {
            var _this2 = this;

            this.denunciaService.obtenerEmergenciabyID(emergenciaID).subscribe(function (emergencia) {
              // console.log(emergencia);
              _this2.emergenciaSeleccionada = emergencia;
              _this2.emergenciaCargada = true;
            });
          }
        }, {
          key: "goBack",
