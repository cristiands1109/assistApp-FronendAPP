(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-verification-verification-module"], {
    ...
    function srcAppPagesVerificationVerificationPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_services_registro_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! src/app/services/registro.service */
      "./src/app/services/registro.service.ts");

      var VerificationPage = /*#__PURE__*/function () {
        function VerificationPage(route, storage, navCtrl, authService, registroService) {
        ...
        _createClass(VerificationPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.registroService.obternerDepartamento().subscribe(function (resp) {
              var _this$departamento;

              (_this$departamento = _this.departamento).push.apply(_this$departamento, _toConsumableArray(resp.Departamento));
            });
          } // al hacer clic en regstrar ejecutamos la siguiente funcion

        }, {
          key: "onRegister",
          value: function onRegister(registerForm) {
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 3:
                      _context.next = 5;
                      return this.registroService.registrarUsuario(this.usuarioRegistro);
          ...
          value: function obtenerDepartamento(event) {
            var data = event.detail.value; // llamamos metodo para obtener las ciudades segun departamentoID

            this.obtenerCiudades(data); // asignamos el departamento ID al objeto de registro de usuario
          ...
          key: "obtenerCiudades",
          value: function obtenerCiudades(depID) {
            var _this2 = this;
            ...
            this.registroService.obtenerCiudades(depID).subscribe(function (resp) {
              ...
              (_this2$ciudades = _this2.ciudades).push.apply(_this2$ciudades, _toConsumableArray(resp.Ciudad));
            });
          }
