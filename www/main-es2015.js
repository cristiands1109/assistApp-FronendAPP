...
const routes = [
    ...
    {
        path: 'login',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-mobile-mobile-module */ "pages-mobile-mobile-module").then(__webpack_require__.bind(null, /*! ./pages/mobile/mobile.module */ "./src/app/pages/mobile/mobile.module.ts")).then(m => m.MobilePageModule)
    },
    {
        path: 'registro',
    ...
    },
    {
        path: 'home',
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]],
        loadChildren: () => Promise.all(/*! import() | pages-home-home-module */[__webpack_require__.e("common"), __webpack_require__.e("home-home-module")]).then(__webpack_require__.bind(null, /*! ./pages/home/home.module */ "./src/app/pages/home/home.module.ts")).then(m => m.HomePageModule)
    },
    {
        path: 'registro-emergencia',
        loadChildren: () => Promise.all(/*! import() | pages-set-reminder-set-reminder-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-set-reminder-set-reminder-module")]).then(__webpack_require__.bind(null, /*! ./pages/set-reminder/set-reminder.module */ "./src/app/pages/set-reminder/set-reminder.module.ts")).then(m => m.SetReminderPageModule)
    },
    {
        path: 'notificaciones',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-my-orders-my-orders-module */ "my-orders-my-orders-module").then(__webpack_require__.bind(null, /*! ./pages/my-orders/my-orders.module */ "./src/app/pages/my-orders/my-orders.module.ts")).then(m => m.MyOrdersPageModule)
    },
    {
        path: 'historial',
        loadChildren: () => Promise.all(/*! import() | pages-documents-documents-module */[__webpack_require__.e("common"), __webpack_require__.e("documents-documents-module")]).then(__webpack_require__.bind(null, /*! ./pages/documents/documents.module */ "./src/app/pages/documents/documents.module.ts")).then(m => m.DocumentsPageModule)
    },
    {
        path: 'perfil',
        loadChildren: () => Promise.all(/*! import() | pages-settings-settings-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-settings-settings-module")]).then(__webpack_require__.bind(null, /*! ./pages/settings/settings.module */ "./src/app/pages/settings/settings.module.ts")).then(m => m.SettingsPageModule)
    },
    {
        path: 'detalle-emergencia',
        loadChildren: () => Promise.all(/*! import() | pages-order-detail-order-detail-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-order-detail-order-detail-module")]).then(__webpack_require__.bind(null, /*! ./pages/order-detail/order-detail.module */ "./src/app/pages/order-detail/order-detail.module.ts")).then(m => m.OrderDetailPageModule)
    },
];
...
/* harmony import */ var _ionic_storage_angular__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ionic/storage-angular */ "./node_modules/@ionic/storage-angular/__ivy_ngcc__/fesm2015/ionic-storage-angular.js");
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, router, storage, usuarioService, pushService) {
...
/* harmony import */ var ionic2_calendar__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ionic2-calendar */ "./node_modules/ionic2-calendar/__ivy_ngcc__/fesm2015/ionic2-calendar.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/http.js");
/* harmony import */ var _ionic_storage_angular__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @ionic/storage-angular */ "./node_modules/@ionic/storage-angular/__ivy_ngcc__/fesm2015/ionic-storage-angular.js");
/* harmony import */ var _ionic_native_file_transfer_ngx__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @ionic-native/file-transfer/ngx */ "./node_modules/@ionic-native/file-transfer/__ivy_ngcc__/ngx/index.js");
...
let AuthGuard = class AuthGuard {
    ...
    canActivate(next, state) {
        ...
        return this.authService.validarToken()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(autenticado => {
...
let AuthService = class AuthService {
    ...
    logIn(celular, password) {
        const data = { celular, password };
        return new Promise(resolve => {
            this.http.post(`${this.url}assistapp/auth/`, data).subscribe(resp => {
    ...
    validarToken() {
        ...
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(resp => true), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(error => Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["of"])(false)));
    }
};
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _ionic_native_onesignal_ngx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic-native/onesignal/ngx */ "./node_modules/@ionic-native/onesignal/__ivy_ngcc__/ngx/index.js");
...
let UsuarioService = class UsuarioService {
    constructor(storage, http, alertController, authService) {
        this.storage = storage;
        this.http = http;
    ...
    obtenerUsuario(token) {
        ...
        return this.http.get(`${this.url}assistapp/auth/getuser`, { headers });
    }
    ...
    getUserbyToken(token) {
        ...
        return this.http.get(`${this.url}assistapp/auth/getuser`, { headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(resp => {
...
module.exports = __webpack_require__(/*! /Users/christianduarte/Documents/00- Christian Duarte/Tesis/00- Code/00- AssistAPP-Frondend/src/main.ts */"./src/main.ts");
