...
/* harmony import */ var _services_accidente_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../services/accidente.service */ "./src/app/services/accidente.service.ts");
...
let SetReminderPage = class SetReminderPage {
    constructor(navCtrl, geo, accidenteService, usuarioService, camera) {
    ...
    ngOnInit() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            yield this.getOptsEmergencias(this.token, this.opcion);
            yield this.getUsuario(this.token);
            yield this.getGeo();
        });
    }
    ...
    registrarEmergencia(emergenciaForm) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this.registroEmergencia = yield emergenciaForm.value;
            this.registroEmergencia.tipo_emergencia = yield this.tipoEmergencia.tipoEmergenciaID;
            if (this.banderaGeo) {
                this.registroEmergencia.latitud = yield this.geodata.coords.latitude;
                this.registroEmergencia.longitud = yield this.geodata.coords.longitude;
            }
            else {
            ...
            if (this.quieresubirIMG) {
                yield this.subirIMG(this.imageStore, this.token);
            }
            else {
                this.registroEmergencia.img = "";
            }
            this.registroEmergencia.denunciante = yield this.userID;
    ...
    subirIMG(image, token) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            console.log('subirIMG', image);
            yield this.accidenteService.subirImagen(image, token).then(data => {
    ...
    registrar(data, emergenciaForm) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            console.log('data registrar', data);
            // console.log('data registrar img', data.img);
            const valido = yield this.accidenteService.registrarEmergencia(data, this.token);
            if (valido) {
