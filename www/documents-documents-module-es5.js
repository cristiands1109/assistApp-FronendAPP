(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["documents-documents-module"], {
    ...
    function srcAppPagesDocumentsDocumentsPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_denuncias_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../../services/denuncias.service */
      ...
      var DocumentsPage = /*#__PURE__*/function () {
        function DocumentsPage(router, modalCtrl, navCtrl, denunciaService, authService, usuarioService) {
        ...
        _createClass(DocumentsPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.usuarioService.getUserbyToken(localStorage.getItem('token')).subscribe(function (_ref) {
              var usuario = _ref.usuario;
              _this.usuarioID = usuario.usuarioID;
          ...
          key: "getEmergencias",
          value: function getEmergencias() {
            var _this2 = this;

            this.denunciaService.obtenerDenuncias().subscribe(function (_ref2) {
              var total = _ref2.total,
                  Emergencia = _ref2.Emergencia;
              // console.log(Emergencia);
              var cont = 0;

              for (var i = 0; i < total; i++) {
                if (Emergencia[i].denunciante['_id'] === _this2.usuarioID) {
                  // console.log(Emergencia[i]);
                  _this2.emergenciasByUser[cont] = Emergencia[i];
                  cont++;
                }
      ...
      DocumentsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
